...
controller('ayatViewController', function ($scope, $sce, ngAudio, ergastAPIservice, $location, $anchorScroll, quranDataService, $q) {
    ...
    $scope.speakers = [{"name": "ڈاکٹر اسرار احمد", "cat": "01"}, {
        "name": "حافظ عاکف سعید",
        "cat": "02"
    }, {"name": "انجینئیر نوید احمد", "cat": "03"}];
